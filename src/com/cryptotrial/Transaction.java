...
public class Transaction {
    ...
    public float value;
    public byte[] signature; // this is to prevent anybody else form spending funds in our wallet
    ...
    //returns true if  new trsansaction could be created
    public boolean processTransaction(){
        ...
        float leftOver = getInputsValue() - value; //get value of inputs then the lefgt over change
